...
public class ItFightsLikeAHyena implements FightBehavior {
	@Override
	public void fight(Organism org1, Organism org2) {
		if(!org1.equals(org2)) {
			
			if(org2 instanceof Hyena || org2 instanceof Human) {
				...
				System.out.println("Sorry, I'm a " + org1.getClass().getSimpleName().toLowerCase() + " and I only fight hyena's and humans !!!");
			}
		}else {
